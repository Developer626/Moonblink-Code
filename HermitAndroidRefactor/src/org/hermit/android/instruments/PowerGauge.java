    ...
    extends Gauge
{
    ...
    public boolean needPowerDb() { return true; }
    ...
    public void setGeometry(Rect bounds) {
        ...
        if (meterTextSize <= th / 2) {
            subWidth = (mw - meterBarMargin * 2);
            
            float split = th * 1f / 3f;
            
            // Still need to take the width into account
            meterTextSize = findTextSize(subWidth, (th - split) * 0.9f, "-100.0dB", paint);
            ...
            // Still need to take the width into account
            meterSubTextSize = findTextSize(subWidth, (th - meterTextSize) * 0.9f, "-100.0dB peak", paint);
