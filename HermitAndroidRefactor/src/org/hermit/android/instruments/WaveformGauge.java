    ...
    extends Gauge
{
	...
	// ******************************************************************** //
	// WRI: Added helper functions.
	// ******************************************************************** //

	protected Canvas getCanvas() { return waveCanvas; }
	protected int getDispWidth() { return dispWidth; }
	protected int getDispHeight() { return dispHeight; }
